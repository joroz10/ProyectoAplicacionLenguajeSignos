...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        realm.copyToRealmOrUpdate(new Palabra("Aceite",R.drawable.aceite,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Alimento",R.drawable.alimento,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Arroz",R.drawable.arroz,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Azucar",R.drawable.azucar,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Bebida",R.drawable.bebida,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Bocadillo",R.drawable.bocadillo,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Caramelo",R.drawable.caramelo,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Carnes",R.drawable.carnes,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Cebolla",R.drawable.cebolla,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Cena",R.drawable.cena,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Chocolate",R.drawable.chocolate,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Comida",R.drawable.comida,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Desayuno",R.drawable.desayuno,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Galleta",R.drawable.galleta,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Huevo",R.drawable.huevo,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Leche",R.drawable.leche,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Lechuga",R.drawable.lechuga,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Limón",R.drawable.limon,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Macarrones",R.drawable.macarrones,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Merienda",R.drawable.merienda,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Pan",R.drawable.pan,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Patata",R.drawable.patata,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Pescado",R.drawable.pescado,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Pollo",R.drawable.pollo,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Puré",R.drawable.pure,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Queso",R.drawable.queso,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Sal",R.drawable.sal,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Sed",R.drawable.sed,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Sopa",R.drawable.sopa,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Tomate",R.drawable.tomate,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Zanahoria",R.drawable.zanahoria,"ComidasYBebidas","ComidasYBebidas"));
        realm.copyToRealmOrUpdate(new Palabra("Zumo",R.drawable.zumo,"ComidasYBebidas","ComidasYBebidas"));

        realm.copyToRealmOrUpdate(new Palabra("Dulce",R.drawable.dulce,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Flan",R.drawable.flan,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Fresa",R.drawable.fresa,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Fruta",R.drawable.fruta,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Helado",R.drawable.helado,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Manzana",R.drawable.manzana,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Naranja",R.drawable.naranja,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Pera",R.drawable.pera,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Platano",R.drawable.platano,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Postre",R.drawable.postre,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Sandía",R.drawable.sandia,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Tarta",R.drawable.tarta,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Uva",R.drawable.uva,"ComidasYBebidas","Postres"));
        realm.copyToRealmOrUpdate(new Palabra("Yogur",R.drawable.yogur,"ComidasYBebidas","Postres"));
        ...
        realm.copyToRealmOrUpdate(new Palabra("Abeja",R.drawable.abeja,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Águila",R.drawable.aguila,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Animal",R.drawable.animal,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Ballena",R.drawable.ballena,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Burro",R.drawable.burro,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Caballo",R.drawable.caballo,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Cabra",R.drawable.cabra,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Camello",R.drawable.camello,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Cerdo",R.drawable.cerdo,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Cocodrilo",R.drawable.cocodrilo,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Conejo",R.drawable.conejo,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Delfín",R.drawable.delfin,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Elefante",R.drawable.elefante,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Foca",R.drawable.foca,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Gallina",R.drawable.gallina,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Gato",R.drawable.gato,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Granja",R.drawable.granja,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Jirafa",R.drawable.jirafa,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("León",R.drawable.leon,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Loro",R.drawable.loro,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Mariposa",R.drawable.mariposa,"Animales","Animales"));
        realm.copyToRealmOrUpdate(new Palabra("Mono",R.drawable.mono,"Animales","Animales"));

        realm.copyToRealmOrUpdate(new Palabra("Abeto",R.drawable.abeto,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Árbol",R.drawable.arbol,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Arcoíris",R.drawable.arco_iris,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Arena",R.drawable.arena,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Estrella",R.drawable.estrella,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Faro",R.drawable.faro,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Flor",R.drawable.flor,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Flotador",R.drawable.flotador,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Fuego",R.drawable.fuego,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Hierba",R.drawable.hierba,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Hoja",R.drawable.hoja,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Lago",R.drawable.lago,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Luna",R.drawable.luna,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Mar",R.drawable.mar,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Margarita",R.drawable.margarita,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Montaña",R.drawable.montana,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Naturaleza",R.drawable.naturaleza,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Palmera",R.drawable.palmera,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Piedra",R.drawable.piedra,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Playa",R.drawable.playa,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Pozo",R.drawable.pozo,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Río",R.drawable.rio,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Saco de dormir",R.drawable.saco_de_dormir,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Sombrilla",R.drawable.sombrilla,"Familia","Naturaleza"));
        realm.copyToRealmOrUpdate(new Palabra("Tienda de campaña",R.drawable.tienda_campana,"Familia","Naturaleza"));

        realm.copyToRealmOrUpdate(new Palabra("Calor",R.drawable.calor,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Frío",R.drawable.frio,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Lluvia",R.drawable.lluvia,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Nieve",R.drawable.nieve,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Nube",R.drawable.nube,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Nublado",R.drawable.nublado,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Sol",R.drawable.sol,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Tiempo atmosfético",R.drawable.tiempo_atmosferico,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Tormenta",R.drawable.tormenta,"Animales","TiempoAtmosferico"));
        realm.copyToRealmOrUpdate(new Palabra("Viento",R.drawable.viento,"Animales","TiempoAtmosferico"));
